...
<body>
  <div class="container"> 
<h1><center>Form Edit Anggota | Perpustakaan Ku</center></h1>
...
<table border="0">
    <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" value="<?php echo $data['nm_anggota']?>">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <textarea name="alamat" class="form-control" ><?php echo $data['ttl_anggota']?></textarea>
        </div>
      </div>
       <div class="form-group">
        <label class="control-label col-sm-2" for="nama">Tempat Tanggal Lahir:</label>
