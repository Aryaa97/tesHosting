 ...
 <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Perpustakaan Ku</a>
        </div>
...
<body>
  <div class="container"> 
<h1><center>Edit Edit Buku | Perpustakaan Ku</center></h1>
...
<table border="0">
    <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="kode"  value="<?php echo $data['judul_buku']?>">
        </div>
        <table border="0">
    <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="kode"  value="<?php echo $data['pengarang']?>">
        </div>
<table border="0">
    <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="kode"  value="<?php echo $data['jenis_buku']?>">
        </div>
<table border="0">
    <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="kode"  value="<?php echo $data['penerbit']?>">
        </div>
</tr>
<tr>
<td></td>
